...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gray-900 px-6 py-10"
  >
    <div
      class="w-full max-w-3xl bg-gray-800 p-8 rounded-lg border border-gray-700 shadow-xl"
    >
